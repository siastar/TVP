    ...
    addProd(newProduct) {
        ...
        axios.post(postDataRoute, newProduct)
            .then(res => {
                ...
                //console.log('added  product: ', justAddedProduct);
        ...
        axios.put(axiosRoute, crudArgs.handledProduct)
            .then(res => {
                ...
                editedProperties.forEach((propertyName) => {
                    ...
                    console.log('zzz propname' , propertyName);
                    console.log('zzz targetproduct',targetProduct)
                    console.log('zzz crudargs handledproduct' , crudArgs.handledProduct);
                });
                ...
                console.log('zzz state' , this.state);

                //reset crudArgs and handledProduct by removing all their properties
                alert('go');
                Object.keys(crudArgs).forEach(function(key) { delete crudArgs[key]; });
                Object.keys(handledProduct).forEach(function(key) { delete handledProduct[key]; });
                //reset newProducts
                //newProducts.length = 0;
            })
