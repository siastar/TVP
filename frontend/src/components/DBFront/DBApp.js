...
class DBApp extends React.Component {
    ...
    constructor(props) {
        ...
        //this.testXYZ = this.testXYZ.bind(this);
    }
    ...
    addProd(newProduct) {
        ...
        axios.post(postDataRoute, newProduct)
            .then(res => {
                ...
                //it happens that copy of the just added product comes back automatically,
                //nested in the/axios response "res.data.message.newdata._id", so we can grab it and push
    ...
    handleCRUDType(crudArgs) { //receives object data defined by triggerCRUDAction in SingleProd.js
        console.log('handleCRUDType args: xxx', crudArgs); //the object looks like:                                                    
